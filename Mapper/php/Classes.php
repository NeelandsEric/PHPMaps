...
class clsLocales {
  ...
  function Init() {
    $this->SetLocale(CCGetSession("ClickYourScada_Lang"));
    $this->SetLocale($this->DefaultLocale);
    CCSetSession("ClickYourScada_Lang", $this->GetFormatInfo("Name"));
    CCSetSession("ClickYourScada_Locale", $this->GetFormatInfo("Language"));
  }
